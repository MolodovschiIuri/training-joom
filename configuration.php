...
class JConfig
{
	...
	public $sitename = 'master\'s Site!';            // Name of Joomla site
	...
	public $password = '6b5d6ba35a';                   // DB password
	public $db = 'bitnami_joomla';                         // DB database name
	public $dbprefix = 'jos_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = '5def3bc3af98702f1b0bdde41507dde7';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '0';
	public $tmp_path = '/opt/lampp/apps/joomla/tmp';                // Please check with your host that this is the correct path to the temp directory. This path needs to be writable by Joomla!
	public $log_path = '/opt/lampp/apps/joomla/logs';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
